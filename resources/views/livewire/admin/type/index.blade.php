        ...
        <div class="col-md-12">
            <div class="card" style="border-radius: 10px; padding-top: 10px;">
                <div class="card-header header-admin">
                    <h2>
                        <a>TYPES LIST:</a>
                        <a href="#" data-bs-toggle="modal" data-bs-target="#addTypeModal" class="btn btn-sm float-end" style="background-color: #C0E5B6; width: 150px; border-radius: 10px;">
                        ...
                        <tbody>
                            @forelse ($types as $type)
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" wire:click="editType({{ $type->id }})" data-bs-toggle="modal" data-bs-target="#updateTypeModal" class="btn btn-primary text-white" style="color: white; width: 120px; border-radius: 10px;">
                                            ...
                                            Edit</a>
                                        <a href="#" wire:click="deleteType({{ $type->id }})" data-bs-toggle="modal" data-bs-target="#deleteTypeModal" class="btn btn-danger" style="color: rgb(0, 0, 0); width: 120px; border-radius: 10px;">
