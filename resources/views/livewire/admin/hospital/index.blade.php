            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="destroyHospital">
                    <div class="modal-body">
                        <p>Are you sure? Are you want to delete this data?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn text-white btn-primary">Yes. Delete</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card" style="border-radius: 10px; padding-top: 10px;">
                <div class="card-header header-admin">
                    <h2 style="color: #002266">HOSPITALS:
                        <a href="{{ url('admin/hospital/create') }}" class="btn btn-sm float-end" style="background-color: #C0E5B6; width: 150px; border-radius: 10px;">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/hospital/'.$hospital->id.'/edit') }}" class="btn btn-primary text-white" style="color: white; width: 120px; border-radius: 10px;">
                                        ...
                                        Edit</a>
                                    <a href="#" wire:click="deleteHospital({{ $hospital->id }})" data-bs-toggle="modal" data-bs-target="#deleteModal"  class="btn btn-danger" style="color: rgb(0, 0, 0); width: 120px; border-radius: 10px;">
