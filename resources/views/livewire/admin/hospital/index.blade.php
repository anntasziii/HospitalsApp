        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header header-admin">
                    <h2>HOSPITALS
                        <a href="{{ url('admin/hospital/create') }}" class="btn btn-sm float-end" style="background-color: #C0E5B6; width: 150px;">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/hospital/'.$hospital->id.'/edit') }}" class="btn btn-primary text-white" style="color: white; width: 120px;">
                                        ...
                                        Edit</a>
                                    <a href="#" wire:click="deleteHospital({{ $hospital->id }})" data-bs-toggle="modal" data-bs-target="#deleteModal"  class="btn btn-danger" style="color: rgb(0, 0, 0); width: 120px;">
