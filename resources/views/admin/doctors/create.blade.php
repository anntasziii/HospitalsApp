    ...
    <div class="col-md-12">
        <div class="card" style="border-radius: 10px; padding-top: 10px;">
            <div class="card-header header-admin">
                <h3 style="color: #002266">ADD DOCTOR:
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                            ...
                            <div class="mb-3">
                                ...
                                <input style="border-radius: 10px" type="text" name="name_of_specialty" class="form-control" />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input style="border-radius: 10px" type="text" name="surname" class="form-control" />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select style="border-radius: 10px" name="type" class="form-control">
