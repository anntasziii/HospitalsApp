    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-admin">
                <h2>EDIT DOCTORS
                    <a href="{{ url('admin/doctors') }}" class="btn btn-danger btn-sm text-white float-end" style="width: 150px;">
                                        ...
                                        <tr class="doctor-time-tr">
                                            ...
                                            <td>
                                                <div class="input-group mb-3" style="width: 200px">
                                                    ...
                                                    <button type="button" value="{{ $doctorTime->id }}" class="updateDoctorTimeBtn btn btn-primary btn-sm text-white" style="color: white; width: 120px;">
                                            ...
                                            <td>
                                                <button type="button" value="{{$doctorTime->id}}" class="deleteDoctorTimeBtn btn btn-danger btn-sm text-black" style="color: rgb(0, 0, 0); width: 120px;">
