    ...
    <div class="col-md-12">
        ...
        <div class="card" style="border-radius: 10px; padding-top: 10px;">
            <div class="card-header header-admin">
                <h2 style="color: #002266">DOCTORS:
                    <a href="{{ url('admin/doctors/create') }}" class="btn btn-sm float-end" style="background-color: #C0E5B6; width: 150px; border-radius: 10px;">
                    ...
                    <tbody>
                        @forelse ($doctors as $doctor)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/doctors/'.$doctor->id.'/edit') }}" class="btn btn-primary text-white" style="color: white; width: 120px; border-radius: 10px;">
                                        ...
                                        Edit</a>
                                    <a href="{{ url('admin/doctors/'.$doctor->id.'/delete') }}" onclick="return confirm('Are you sure? Are you want to delete this data?')" class="btn btn-danger" style="color: rgb(0, 0, 0); width: 120px; border-radius: 10px;">
