                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset("$slider->image") }}" style="width:150px; height: 70px;  border-radius: 10%;" alt="Slider">
                            </td>
                            <td>{{$slider->status == '0' ? 'Visible':'Hidden'}}</td>
                            <td>
                                <a href="{{url('admin/sliders/'.$slider->id.'/edit')}}" class="btn btn-primary text-white" style="color: white; width: 120px;">
                                ...
                                <a href="{{url('admin/sliders/'.$slider->id.'/delete')}}"
                                    ...
                                    class="btn btn-danger" style="color: rgb(0, 0, 0); width: 120px;">
