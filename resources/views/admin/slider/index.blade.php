    ...
    <div class="col-md-12">
        ...
        <div class="card" style="border-radius: 10px; padding-top: 10px;">
            <div class="card-header header-admin">
                <h2><a style="color: #002266">SLIDER LIST:</a>
                    <a href="{{ url('admin/sliders/create') }}" class="btn btn-sm float-end" style="background-color: #C0E5B6; width: 150px; border-radius: 10px;">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset("$slider->image") }}" style="width:150px; height: 70px;  border-radius: 10px;" alt="Slider">
                            </td>
                            <td>{{$slider->status == '0' ? 'Visible':'Hidden'}}</td>
                            <td>
                                <a href="{{url('admin/sliders/'.$slider->id.'/edit')}}" class="btn btn-primary text-white" style="color: white; width: 120px; border-radius: 10px;">
                                ...
                                <a href="{{url('admin/sliders/'.$slider->id.'/delete')}}"
                                    onclick="return confirm('Are you sure? Are you want to delete slider?');"
                                    class="btn btn-danger" style="color: rgb(0, 0, 0); width: 120px; border-radius: 10px;">
