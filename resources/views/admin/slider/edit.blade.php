    ...
    <div class="col-md-12">
        ...
        <div class="card" style="border-radius: 10px; padding-top: 10px;">
            <div class="card-header header-admin">
                <h2 style="color: #002266">EDIT SLIDER:
                    <a href="{{ url('admin/sliders/') }}" class="btn btn-danger btn-sm text-white float-end" style="width: 150px; border-radius: 10px;">
                ...
                <form action="{{ url('admin/sliders/'.$slider->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="checkbox-wrapper-7">
                            <input class="tgl tgl-ios" id="cb2-7" name="status" {{$slider->status == '1' ? 'checked':''}} type="checkbox"/>
