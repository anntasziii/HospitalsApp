    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-admin">
                <h2>EDIT SLIDER
                    <a href="{{ url('admin/sliders/') }}" class="btn btn-danger btn-sm text-white float-end" style="width: 150px;">
            ...
            <div class="card-body">
                <form action="{{ url('admin/sliders/'.$slider->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{asset("$slider->image")}}" style="width: 150px; height: 70px" alt="Slider" />
                    </div>
                    <div class="mb-3">
