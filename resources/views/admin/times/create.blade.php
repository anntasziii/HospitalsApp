    ...
    <div class="col-md-12">
        ...
        <div class="card" style="border-radius: 10px; padding-top: 10px;">
            <div class="card-header header-admin">
                <h2 style="color: #002266">ADD TIMES:
                    <a href="{{ url('admin/times') }}" class="btn btn-danger btn-sm text-white float-end" style="width: 150px; border-radius: 10px;">
            ...
            <div class="card-body">
                <form action="{{ url('admin/times/create') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label>Time</label>
                        <input style="border-radius: 10px" type="text" name="name" class="form-control" placeholder="00:00">
                    </div>
                    <div class="mb-3">
                        <label class="mb-2">Status (Checked = Hidden, UnChacked = Visible)</label><br />
                        <div class="checkbox-wrapper-7">
                            <input class="tgl tgl-ios" id="cb2-7" name="status" type="checkbox"/>
