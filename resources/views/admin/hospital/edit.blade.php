    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header header-admin">
                <h2>EDIT HOSPITAL
                    <a href="{{ url('admin/hospital') }}" class="btn btn-danger btn-sm text-white float-end" style="width: 150px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="checkbox-wrapper-7">
                                <input class="tgl tgl-ios" id="cb2-7" type="checkbox" name="status" {{ $hospital->status =='1' ? 'checked':'' }}/>
                                @error('status') <small class="text-danger">{{$message}}</small> @enderror
                                <label class="tgl-btn" for="cb2-7">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <h4 class="mb-4 mt-4">SEO TAGS</h4>
                        </div>
                        <div class="col-md-12 mb-3">
                        ...
                        <div class="col-md-12 mb-3">
                            <button type="submit" class="btn btn-primary text-white" style="width: 200px;">
