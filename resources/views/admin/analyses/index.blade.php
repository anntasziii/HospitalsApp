    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-admin">
                <h2>ANALYSES
                    <a href="{{ url('admin/analyses/create') }}" class="btn btn-sm float-end" style="background-color: #C0E5B6; width: 150px;">
                    ...
                    <tbody>
                        @forelse ($analyses as $analysis)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/analyses/'.$analysis->id.'/edit') }}" class="btn btn-primary text-white" style="color: white; width: 120px;">
                                        ...
                                        Edit</a>
                                    <a href="{{ url('admin/analyses/'.$analysis->id.'/delete') }}" onclick="return confirm('Are you sure? Are you want to delete this data?')" class="btn btn-danger" style="color: rgb(0, 0, 0); width: 120px;">
