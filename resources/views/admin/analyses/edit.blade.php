                                        ...
                                        <tr class="analysis-time-tr">
                                            ...
                                            <td>
                                                <div class="input-group mb-3" style="width: 200px">
                                                    ...
                                                    <button type="button" value="{{ $analysisTime->id }}" class="updateAnalysisTimeBtn btn btn-primary btn-sm text-white" style="color: white; width: 120px;">
                                            ...
                                            <td>
                                                <button type="button" value="{{$analysisTime->id}}" class="deleteAnalysisTimeBtn btn btn-danger btn-sm text-black" style="color: rgb(0, 0, 0); width: 120px;">
