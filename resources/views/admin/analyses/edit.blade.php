    ...
    <div class="col-md-12">
        ...
        <div class="card" style="border-radius: 10px; padding-top: 10px;">
            <div class="card-header header-admin">
                <h3 style="color: #002266">EDIT ANALYSIS:
                    <a href="{{ url('admin/analyses') }}" class="btn btn-danger btn-sm text-white float-end" style="width: 150px; border-radius: 10px;">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                            <div class="mb-3">
                                ...
                                <select name="hospitals_id" class="form-control" style="border-radius: 10px; height: 45px;">
                            ...
                            <div class="mb-3">
                                ...
                                <input style="border-radius: 10px" type="text" name="name" value="{{ $analysis->name }}" class="form-control" />
                            </div>
                            <div class="mb-3">
                                <label class="mb-2 mt-2">Analysis Slug</label>
                                <input style="border-radius: 10px" type="text" name="slug" value="{{ $analysis->slug }}" class="form-control" />
                            </div>
                            <div class="mb-3">
                                <label class="mb-2 mt-2">Select Type</label>
                                <select name="type" class="form-control">
                                    @foreach ($types as $type)
                                        <option style="border-radius: 10px" value="{{ $type->name }}" {{ $type->name == $analysis->type ? 'selected':'' }}>
                                            {{ $type->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea style="border-radius: 10px" name="small_description" class="form-control" rows="4">{{ $analysis->small_description }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="mb-2 mt-2">Description</label>
                                <textarea style="border-radius: 10px"name="description" class="form-control" rows="4">{{ $analysis->description }}</textarea>
                            </div>
                        </div>
                        <div class="tab-pane fade border p-3" id="seotag-tab-pane" role="tabpanel" aria-labelledby="seotag-tab" tabindex="0">
                            <div class="mb-3">
                                <label class="mb-2 mt-3">Meta Title</label>
                                <input style="border-radius: 10px" type="text" name="meta_title" value="{{ $analysis->meta_title }}" class="form-control" />
                            </div>
                            <div class="mb-3">
                                <label class="mb-2 mt-2">Meta Description</label>
                                <textarea style="border-radius: 10px" name="meta_description" class="form-control" rows="4">{{ $analysis->meta_description }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="mb-2 mt-2">Meta Keyword</label>
                                <textarea style="border-radius: 10px" name="meta_keyword" class="form-control" rows="4">{{ $analysis->meta_keyword }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input style="border-radius: 10px" type="text" name="original_price" value="{{ $analysis->original_price }}" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="mb-2 mt-3">Quantity</label>
                                        <input style="border-radius: 10px" type="number" name="quantity" value="{{ $analysis->quantity }}" class="form-control" />
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="mb-2 mt-2">Trending</label>
                                    <div class="checkbox-wrapper-7">
                                        <input class="tgl tgl-ios" id="cb2-7" name="trending" {{ $analysis->trending == '1' ? 'checked':'' }} type="checkbox"/>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="checkbox-wrapper-7">
                                        <input class="tgl tgl-ios" id="cb2-8" name="featured" {{ $analysis->featured == '1' ? 'checked':'' }} type="checkbox"/>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="checkbox-wrapper-7">
                                        <input class="tgl tgl-ios" id="cb2-9"  name="status" {{ $analysis->status == '1' ? 'checked':'' }} type="checkbox"/>
                                        ...
                                        <tr class="analysis-time-tr">
                                            ...
                                            <td>
                                                <div class="input-group mb-3" style="width: 200px">
                                                    <input type="text" value="{{ $analysisTime->quantity }}" class="analysisTimeQuantity form-control form-control-sm" style="border-top-left-radius: 10px; border-bottom-left-radius: 10px;" />
                                                    <button type="button" value="{{ $analysisTime->id }}" class="updateAnalysisTimeBtn btn btn-primary btn-sm text-white" style="color: white; width: 120px; border-top-right-radius: 10px; border-bottom-right-radius: 10px;">
                                            ...
                                            <td>
                                                <button type="button" value="{{$analysisTime->id}}" class="deleteAnalysisTimeBtn btn btn-danger btn-sm text-black" style="color: rgb(0, 0, 0); width: 120px; border-radius: 10px;">
