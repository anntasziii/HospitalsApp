    ...
    <div class="col-md-12">
        ...
        <div class="card" style="border-radius: 10px; padding-top: 10px;">
            <div class="card-header header-admin">
                <h2 style="color: #002266">EDIT USER:
                    <a href="{{ url('admin/users') }}" class="btn btn-danger btn-sm text-white float-end" style="width: 150px; border-radius: 10px;">
                ...
                <form action="{{url('admin/users/'.$user->id)}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label>Name</label>
                            <input style="border-radius: 10px" type="text" name="name" value="{{$user->name}}" class="form-control" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Email</label>
                            <input style="border-radius: 10px" type="text" name="email" readonly value="{{$user->email}}" class="form-control" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Password</label>
                            <input style="border-radius: 10px" type="text" name="password" class="form-control" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Select role</label>
                            <select style="border-radius: 10px; height: 45px;" name="role_as" class="form-control">
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary text-white" style="width: 150px; border-radius: 10px;">
