    ...
    <div class="col-md-12">
        ...
        <div class="card" style="border-radius: 10px; padding-top: 10px;">
            <div class="card-header header-admin">
                <h2><a style="color: #002266">USER LIST:</a>
                    <a href="{{ url('admin/users/create') }}" class="btn btn-sm float-end" style="background-color: #C0E5B6; width: 150px; border-radius: 10px;">
                    ...
                    <tbody>
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td>
                                    @if ($user->role_as == '0')
                                    <label class="badge" style="height: 30px; width: 100px; border-radius: 10px; display: flex; align-items: center; justify-content: center; background-color: rgb(77, 131, 255);">User</label>
                                    @elseif ($user->role_as == '1')
                                    <label class="badge" style="height: 30px; width: 100px; border-radius: 10px; display: flex; align-items: center; justify-content: center; background-color: #C0E5B6; color: black;">Admin</label>
                                    @else
                                    <label class="badge" style="height: 30px; width: 100px; border-radius: 10px; display: flex; align-items: center; justify-content: center; background-color: red;">None</label>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ url('admin/users/'.$user->id.'/edit') }}" class="btn btn-primary text-white" style="color: white; width: 120px; border-radius: 10px;">
                                        ...
                                        Edit</a>
                                    <a href="{{ url('admin/users/'.$user->id.'/delete') }}" onclick="return confirm('Are you sure? Are you want to delete this data?')" class="btn btn-danger" style="color: rgb(0, 0, 0); width: 120px; border-radius: 10px;">
